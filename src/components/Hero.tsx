  ...
  return (
    <section className="tf-hero relative z-20 overflow-visible bg-transparent px-4 pb-4 pt-8 text-brand-charcoal sm:px-8 sm:pb-6 sm:pt-12 lg:px-10 lg:pb-8 lg:pt-14">
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden select-none">
        ...
        <div className="absolute bottom-0 right-[4%] h-[42%] w-[48%] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.28),transparent_70%)] blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] md:gap-8 lg:gap-10 xl:gap-14">
        <motion.div
